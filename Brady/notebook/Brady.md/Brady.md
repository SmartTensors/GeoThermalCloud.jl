...
<a href="map/dataset-set00-v9-inv.html">Link to "map/dataset-set00-v9-inv.html".</a>
...
- Type 1: Merge depth and attribute tensor dimensions; in this way, the focus is on finding the features associated with the locations
- Type 2: Merge depth and location tensor dimensions; in this way, the focus is on finding the features associated with the attributes
