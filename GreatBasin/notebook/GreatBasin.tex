...
REPL
\texttt{import\ Pkg;\ Pkg.add("GeoThermalCloud");\ import\ Pkg;\ Pkg.add("NMFk");\ Pkg.add("Mads");\ Pkg.add("DelimitedFiles");\ Pkg.add("JLD");\ Pkg.add("Gadfly");\ Pkg.add("Cairo");\ Pkg.add("Fontconfig");\ Pkg.add("Kriging");\ Pkg.add("GMT");}.
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{cd}\PY{p}{(}\PY{n}{joinpath}\PY{p}{(}\PY{n}{GeoThermalCloud}\PY{o}{.}\PY{n}{dir}\PY{p}{,} \PY{l+s}{\PYZdq{}}\PY{l+s}{G}\PY{l+s}{r}\PY{l+s}{e}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{B}\PY{l+s}{a}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{p}{;}
\PY{n}{include}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{g}\PY{l+s}{m}\PY{l+s}{t}\PY{l+s}{p}\PY{l+s}{l}\PY{l+s}{o}\PY{l+s}{t}\PY{l+s}{\PYZus{}}\PY{l+s}{g}\PY{l+s}{r}\PY{l+s}{e}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{b}\PY{l+s}{a}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{n}\PY{l+s}{.}\PY{l+s}{j}\PY{l+s}{l}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \hypertarget{map-locations}{%
\subsubsection{Map locations}\label{map-locations}}

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{6}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{GMT}\PY{o}{.}\PY{n}{grdimage}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{a}\PY{l+s}{p}\PY{l+s}{s}\PY{l+s}{/}\PY{l+s}{g}\PY{l+s}{r}\PY{l+s}{e}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{b}\PY{l+s}{a}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{n}\PY{l+s}{\PYZhy{}}\PY{l+s}{v}\PY{l+s}{3}\PY{l+s}{.}\PY{l+s}{n}\PY{l+s}{c}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{proj}\PY{o}{=}\PY{o}{:}\PY{n}{Mercator}\PY{p}{,} \PY{n}{shade}\PY{o}{=}\PY{p}{(}\PY{n}{azimuth}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{,} \PY{n}{norm}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{e}\PY{l+s}{0}\PY{l+s}{.}\PY{l+s}{8}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{,}
	\PY{n}{color}\PY{o}{=}\PY{n}{GMT}\PY{o}{.}\PY{n}{makecpt}\PY{p}{(}\PY{n}{color}\PY{o}{=}\PY{o}{:}\PY{n}{grayC}\PY{p}{,} \PY{n}{transparency}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{5000}\PY{p}{,}\PY{l+m+mi}{500}\PY{p}{)}\PY{p}{,} \PY{n}{continuous}\PY{o}{=}\PY{k+kc}{true}\PY{p}{)}\PY{p}{,}
	\PY{n}{figsize}\PY{o}{=}\PY{l+m+mi}{8}\PY{p}{,} \PY{n}{conf}\PY{o}{=}\PY{p}{(}\PY{n}{MAP\PYZus{}FRAME\PYZus{}TYPE}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{p}\PY{l+s}{l}\PY{l+s}{a}\PY{l+s}{i}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{MAP\PYZus{}GRID\PYZus{}PEN\PYZus{}PRIMARY}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{h}\PY{l+s}{i}\PY{l+s}{n}\PY{l+s}{n}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{t}\PY{l+s}{,}\PY{l+s}{g}\PY{l+s}{r}\PY{l+s}{a}\PY{l+s}{y}\PY{l+s}{,}\PY{l+s}{.}\PY{l+s}{\PYZdq{}}\PY{p}{,}
	...
	\PY{n}{MAP\PYZus{}TICK\PYZus{}LENGTH\PYZus{}PRIMARY}\PY{o}{=}\PY{l+m+mf}{0.01}\PY{p}{)}\PY{p}{,} \PY{n}{frame}\PY{o}{=}\PY{p}{(}\PY{n}{axis}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{l}\PY{l+s}{r}\PY{l+s}{t}\PY{l+s}{b}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
\PY{n}{GMT}\PY{o}{.}\PY{n}{plot!}\PY{p}{(}\PY{n}{xcoord}\PY{p}{,} \PY{n}{ycoord}\PY{p}{,} \PY{n}{fill}\PY{o}{=}\PY{o}{:}\PY{n}{cyan}\PY{p}{,} \PY{n}{marker}\PY{o}{=}\PY{o}{:}\PY{n}{c}\PY{p}{,} \PY{n}{markersize}\PY{o}{=}\PY{l+m+mf}{0.075}\PY{p}{,} \PY{n}{coast}\PY{o}{=}\PY{p}{(}\PY{n}{proj}\PY{o}{=}\PY{o}{:}\PY{n}{Mercator}\PY{p}{,} 
    \PY{n}{DCW}\PY{o}{=}\PY{p}{(}\PY{n}{country}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{U}\PY{l+s}{T}\PY{l+s}{,}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{N}\PY{l+s}{V}\PY{l+s}{,}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{C}\PY{l+s}{A}\PY{l+s}{,}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{A}\PY{l+s}{Z}\PY{l+s}{,}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{O}\PY{l+s}{R}\PY{l+s}{,}\PY{l+s}{U}\PY{l+s}{S}\PY{l+s}{.}\PY{l+s}{I}\PY{l+s}{D}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{pen}\PY{o}{=}\PY{p}{(}\PY{l+m+mf}{0.5}\PY{p}{,}\PY{o}{:}\PY{n}{black}\PY{p}{)}\PY{p}{)}\PY{p}{)}\PY{p}{,}
    \PY{n}{fmt}\PY{o}{=}\PY{o}{:}\PY{n}{png}\PY{p}{,} \PY{n}{savefig}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{a}\PY{l+s}{p}\PY{l+s}{s}\PY{l+s}{\PYZhy{}}\PY{l+s}{d}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{a}\PY{l+s}{/}\PY{l+s}{l}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{s}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{show}\PY{o}{=}\PY{k+kc}{true}\PY{p}{)}\PY{p}{;}
\PY{n}{Mads}\PY{o}{.}\PY{n}{display}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{a}\PY{l+s}{p}\PY{l+s}{s}\PY{l+s}{\PYZhy{}}\PY{l+s}{d}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{a}\PY{l+s}{/}\PY{l+s}{l}\PY{l+s}{o}\PY{l+s}{c}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{s}\PY{l+s}{.}\PY{l+s}{p}\PY{l+s}{n}\PY{l+s}{g}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
┌ Warning: In Jupyter you can only visualize png files. File maps-
data/locations.png was saved in disk though.
└ @ GMT /Users/vvv/.julia/packages/GMT/dCcJn/src/common\_options.jl:2950
    \end{Verbatim}
...
Temperature: Min 0.1 Max 275.0 StdDev 25.12217 Skewness 4.087667 Count 13894
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_6.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_15.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_24.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_33.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_34.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_37.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_40.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_43.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_46.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_17_49.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkIO.jl:114
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_4.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_5.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_7.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_8.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_10.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_11.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_13.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_14.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_16.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_17.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_19.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_20.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_22.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_23.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_25.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_19_26.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:54
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_6.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_7.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_10.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_11.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_14.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_17.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_18.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_21.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_24.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_27.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_28.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_31.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_34.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_35.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPreprocess.jl:51
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_22_38.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_38_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
10×2 Matrix\{Any\}:
 ...
 "K"            0.58262
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_6.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPostprocess.jl:282
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_8.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_10.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_11.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_13.png}
    \end{center}
    { \hspace*{\fill} \\}
...
2596×2 Matrix\{Any\}:
 ...
 "470"    0.241611
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_17.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPostprocess.jl:378
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_19.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_21.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ NMFk /Users/vvv/.julia/dev/NMFk/src/NMFkPostprocess.jl:431
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_24.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_26.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{GreatBasin_files/GreatBasin_40_27.png}
    \end{center}
    { \hspace*{\fill} \\}
