...
attributes_short = ["wellid", "md", "azimuth", "inclination", "x", "y", "z", "casing", "fluids", "use", "production", "use2", "lt750mstatus", "normal", "coulomb", "dilation", "faults", "td", "ts", "curve", "modeltemp", "faultdense", "faultintdense", "distfromcontacts", "distfromfaults", "unitthickness", "goodlith", "confidence"]
attributes_long = ["ID", "Depth", "Azimuth", "Inclination", "X", "Y", "Z", "Casing", "Fluids", "use", "Production", "use2", "Status", "Normal stress", "Coulomb shear stress", "Dilation", "Faulting", "Fault dilation tendency", "Fault slip tendency", "Fault curvature", "Temperature", "Fault density", "Fault intersection density", "Distance from contacts", "Distance from faults", "Unit thickness", "Lithology", "Confidence"]
...
d, h = DelimitedFiles.readdlm("data/AllBradyWells_LANL_ML_5.txt", ','; header=true)
